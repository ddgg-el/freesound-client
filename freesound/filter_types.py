...
class TypeFilter(TypedDict):
	...
	bitrate:Optional[int|float]
	samplerate:Optional[int]
	filesize:Optional[int] # in bytes
	channels:Optional[int]
	md5:Optional[str]
	num_downloads:Optional[int]
	avg_rating:Optional[int|float]
	num_comments:Optional[int]
	# Audio Common
	ac_loudness:Optional[int|float]
	ac_dynamical_range:Optional[int|float]
	ac_temporal_centroid:Optional[int|float]
	ac_log_attack_time:Optional[int|float]
	...
	ac_note_frequency:Optional[int|float]
